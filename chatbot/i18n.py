...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "es": {
        ...
        "triaje_resultado_prioritario": "Hemos marcado tu caso como prioritario: solo podrás reservar el día más próximo disponible.",
    ...
    "eu": {
        ...
        "triaje_resultado_prioritario": "Zure kasua lehentasunezko gisa markatu dugu: hurrengo egun erabilgarrian bakarrik erreserbatu ahal izango duzu.",
