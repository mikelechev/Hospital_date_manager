...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "es": {
        ...
        "triaje_resultado_prioritario": "Hemos marcado tu caso como prioritario. En la pestaña de Agenda solo podrás reservar el día más próximo disponible.",
        "triaje_resultado_normal": "Gracias. No hemos detectado nada que requiera prioridad especial — puedes reservar con normalidad en la pestaña de Agenda.",
        "triaje_ir_a_agenda": "Ve a la pestaña “📅 Agenda” para reservar tu cita.",
        ...
        "agenda_triaje_prioritario_aviso": "El triaje previo marcó tu caso como prioritario: solo puedes reservar el día más próximo disponible.",
    ...
    "eu": {
        ...
        "triaje_resultado_prioritario": "Zure kasua lehentasunezko gisa markatu dugu. Agenda fitxan hurrengo egun erabilgarrian bakarrik erreserbatu ahal izango duzu.",
        "triaje_resultado_normal": "Eskerrik asko. Ez dugu lehentasun berezirik behar duen ezer detektatu — normal erreserba dezakezu Agenda fitxan.",
        "triaje_ir_a_agenda": "Joan “📅 Agenda” fitxara zure hitzordua erreserbatzeko.",
        ...
        "agenda_triaje_prioritario_aviso": "Aurretiko triajeak zure kasua lehentasunezko gisa markatu du: hurrengo egun erabilgarrian bakarrik erreserbatu dezakezu.",
